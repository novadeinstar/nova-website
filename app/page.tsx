    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Access NOVA instantly on your phone and explore our
            NextGen Observational Voice Assistant experience.
          </p>
        </div>
        ...
        >
          <img
            src={`https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent("https://nova.sfzhamburg.de")}`}
            alt="NOVA QR Code"
            style={{
              width: "100%",
              maxWidth: "260px",
